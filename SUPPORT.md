...
- Use **Discussions** for usage questions, extension-development guidance, and ideas that are not
  yet actionable defects.
...
This repository is not a public support channel for:

- proprietary 172X Command internals;
- private account, payment, or license details;
- provider credentials or third-party account recovery;
- general programming support unrelated to a marketplace package;
- guaranteed feature delivery, package acceptance, or response times.

Never post credentials, license keys, private source, terminal output containing secrets, personal
data, or security vulnerabilities in a public support thread.
